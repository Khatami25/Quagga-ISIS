...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        defaultIP1 = '192.168.0.0/24'	# IP address for r1-eth0
        defaultIP2 = '192.168.3.0/24'	# IP address for r2-eth0
        defaultIP3 = '192.168.1.0/24'	# IP address for r3-eth0
        ...
        h1 = self.addHost( 'h1', ip='192.168.0.2/24', defaultRoute='via 192.168.0.0') #define gateway
        h2 = self.addHost( 'h2', ip='192.168.3.2/24', defaultRoute='via 192.168.3.0')
        h3 = self.addHost( 'h3', ip='192.168.1.2/24', defaultRoute='via 192.168.1.0') #define gateway


	self.addLink(router1,router2,intfName1='r1-eth1',params1={ 'ip' : '192.168.0.3/24' }, intfName2='r2-eth1')
	self.addLink(router2,router3,intfName1='r2-eth2',params1={ 'ip' : '192.168.3.3/24' }, intfName2='r3-eth1')
	self.addLink(router3,router1,intfName1='r3-eth2',params1={ 'ip' : '192.168.1.3/24' }, intfName2='r1-eth2')  
	
	self.addLink(h1,router1,intfName2='r1-eth3',params2={ 'ip' : '192.168.0.1/24' })#params2 define the eth2 ip address
	self.addLink(h2,router2,intfName2='r2-eth3',params2={ 'ip' : '192.168.3.1/24' })
	self.addLink(h3,router3,intfName2='r3-eth3',params2={ 'ip' : '192.168.1.1/24' })
